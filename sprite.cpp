...
Sprite::Sprite(float scale) : Geometry()
{
    // Initialize variables with default values
    vbo_ = 0;
    ebo_ = 0;
...
void Sprite::CreateGeometry(void){
    ...
    GLfloat vertex[]  = {
        ...
        -0.5f,  0.5f,    1.0f, 0.0f, 0.0f,    0.0f * texture_scale_, 0.0f * texture_scale_, // Top-left
         0.5f,  0.5f,    0.0f, 1.0f, 0.0f,    1.0f * texture_scale_, 0.0f * texture_scale_, // Top-right
         0.5f, -0.5f,    0.0f, 0.0f, 1.0f,    1.0f * texture_scale_, 1.0f * texture_scale_, // Bottom-right
        -0.5f, -0.5f,    1.0f, 1.0f, 1.0f,    0.0f * texture_scale_, 1.0f * texture_scale_  // Bottom-left
    };
